...
Vagrant.configure(2) do |config|
  ...
  config.vm.network :forwarded_port, guest: 8000, host: 8000 # SIP e SEI (Apache - HTTP)
  config.vm.network :forwarded_port, guest: 8443, host: 8443 # SIP e SEI (Apache - HTTPS)
