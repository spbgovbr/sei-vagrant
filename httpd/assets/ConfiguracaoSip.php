	...
	public function getArrConfiguracoes(){
		return array(
			...
			'SessaoSip' => array(
                ...
                'ChaveAcesso' => 'd27791b8767f696ba6d989e373da18e5aff2ce6b20cbd4cf65e6f8d9035fabde179b619c', //Chave para validaзгo de acesso aos webservices do SIP. Gerar uma nova chave logando como Administrador no SIP, menu "Sistemas/Listar" e acionar a aзгo ?Gerar Chave de Acesso? para o sistema SIP.
                'https' => false,
			),
...
//			),
            ...
            'InfraMail' => array(
                'Tipo' => '1', //1 = sendmail (neste caso nгo й necessбrio configurar os atributos abaixo), 2 = SMTP
                'Servidor' => 'smtp',
                'Porta' => '1025',
                'Codificacao' => '8bit', //8bit, 7bit, binary, base64, quoted-printable
                'Autenticar' => false, //se true entгo informar Usuario e Senha
                'Usuario' => '',
                'Senha' => '',
                ...
                'Protegido' => '', //campo usado em desenvolvimento, se tiver um email preenchido entao todos os emails enviados terao o destinatario ignorado e substituнdo por este valor (evita envio incorreto de email)
                /*  Abaixo chave opcional desativada com exemplo de preenchimento
                'Dominios' => array(	// Opcional. Permite especificar o conjunto de atributos acima individualmente para cada domнnio de conta remetente. Se nгo existir um domнnio mapeado entгo utilizarб os atributos gerais da chave InfraMail.
                    'abc.jus.br' => array(
                        'Tipo' => '2',
                        'Servidor' => '10.1.3.12',
                        'Porta' => '25',
